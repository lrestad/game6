...
void DrawLines::draw_quad(float xmin, float ymin, float xmax, float ymax, glm::u8vec4 const &color) {
	draw(glm::vec3(xmin, ymin, 0.0f), glm::vec3(xmax, ymin, 0.0f), color);
	draw(glm::vec3(xmin, ymax, 0.0f), glm::vec3(xmax, ymax, 0.0f), color);
	draw(glm::vec3(xmin, ymin, 0.0f), glm::vec3(xmin, ymax, 0.0f), color);
	draw(glm::vec3(xmax, ymin, 0.0f), glm::vec3(xmax, ymax, 0.0f), color);
}
